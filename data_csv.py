...
def csv_file():
    ...
    try:
        ...
        if type_station == 1:  # Screwing
            ...
            csv_data = get_complete_tests_csv(piece_id, station_name, csv_data)
...
def get_complete_tests_csv(piece_id, station_name, csv_data):
    ...
    for x in screwing:
        ...
        if x[6] == "1":
            ...
            resultado = "Failed"
        # Parámetros de la prueba
        csv_data.append(["Data Type", str(x[4])])
        csv_data.append(["Compoperator", str(x[7])])
        csv_data.append(["Lowerlimit", str(x[2])])
        csv_data.append(["Upperlimit", str(x[3])])
        csv_data.append(["Value", str(x[1])])
        csv_data.append(["Decription", str(x[9])])
        csv_data.append(["Result", resultado])
        csv_data.append(["Test Time", x[8]])
        csv_data.append(["Units", x[5]])
        csv_data.append([])  # Fila vacía entre pruebas
    ...
    for x in continuity:
        ...
        # Parámetros de la prueba
        csv_data.append(["Data Type", "Numeric"])
        csv_data.append(["Compoperator", str(x[2])])
        csv_data.append(["Lowerlimit", str(x[3])])
        csv_data.append(["Upperlimit", str(x[4])])
        csv_data.append(["Value", str(x[7])])
        csv_data.append(["Decription", str(x[1])])
        csv_data.append(["Result", resultado])
        csv_data.append(["Test Time", timer])
        csv_data.append(["Units", x[5]])
        csv_data.append([])  # Fila vacía entre pruebas
    ...
    for x in leak:
        ...
        csv_data.append(["Data Type", "Numeric"])
        csv_data.append(["Compoperator", str(x[8])])
        csv_data.append(["Lowerlimit", str(x[6])])
        csv_data.append(["Upperlimit", str(x[7])])
        csv_data.append(["Value", str(x[2])])
        csv_data.append(["Decription", str(x[5])])
        csv_data.append(["Result", resultado])
        csv_data.append(["Test Time", timer])
        csv_data.append(["Units", x[4]])
        csv_data.append([])  # Fila vacía entre pruebas
    ...
    for x in welding:
        ...
        csv_data.append(["Data Type", "Numeric"])
        csv_data.append(["Compoperator", str(x[8])])
        csv_data.append(["Lowerlimit", "0.0"])
        csv_data.append(["Upperlimit", "0.0"])
        csv_data.append(["Value", str(x[3])])
        csv_data.append(["Decription", str(x[4])])
        csv_data.append(["Result", resultado])
        csv_data.append(["Test Time", timer])
        csv_data.append(["Units", x[6]])
        csv_data.append([])  # Fila vacía entre pruebas
